    ...
    <section>
      <article class="qna">
        ...
        <div class="footer-images">
          <img src="~/assets/img/footer/insta.png" alt="인스타그램" />
          <img src="~/assets/img/footer/kakao.png" alt="카카오톡" />
          <img src="~/assets/img/footer/youtube.png" alt="유튜브" />
          <img
          ...
          />
          <img
            src="~/assets/img/footer/appstore.png"
            alt="앱스토어"
            class="hide-image"
          />
        </div>
